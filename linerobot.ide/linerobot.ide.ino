...
analogWrite(enA, 10); // Write The Duty Cycle 0 to 255 Enable Pin A for Motor1 Speed 
analogWrite(enB, 170); // Write The Duty Cycle 0 to 255 Enable Pin B for Motor2 Speed 
delay(1000);
}
void loop(){  
